...
if(isset($_POST['prd_featured'])){
    ...
    $sql1 = "INSERT INTO product(prd_name,prd_price,prd_warranty,prd_accessories,prd_promotion,prd_new,prd_image,prd_status,cat_id,prd_featured,prd_details) 
             VALUES ('$prd_name', '$prd_price', '$prd_warranty', '$prd_accessories', '$prd_promotion', '$prd_new', '$prd_image', '$prd_status','$cat_id','$prd_featured','$prd_details')";
