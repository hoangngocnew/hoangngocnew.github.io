...
<div id="my-cart">
 ...
 <div class="cart-item row">
        ...
        <div class="cart-quantity col-lg-2 col-md-2 col-sm-12">
            <input name="quantity[<?php echo $row['prd_id'];?>]" type="number" id="quantity" class="form-control form-blue quantity" value="<?php echo $_SESSION['cart'][$row['prd_id']];?>" min="1">
        </div> 
...
if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['mail']) && isset($_POST['add'])){
    ...
    <tr>
			...
			<td width="20%"><b><font color="#FF0000">'.$total_all.' đ</font></b></td>
		</tr>
	</table>	
    ';
    $str_body.='
